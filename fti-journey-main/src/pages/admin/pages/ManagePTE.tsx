...
const ManagePTE = () => {
  ...
  const handleSave = () => {
    updateCMSData({
      pteHeroTitle: heroTitle,
      pteHeroDescription: heroDescription,
      pteSuccessImages: successImages,
    });
    toast({
      title: "Success",
      description: "PTE Page content updated successfully!",
    });
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold text-slate-800">Manage PTE Page</h1>
