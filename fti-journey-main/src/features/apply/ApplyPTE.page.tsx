  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await fetch(`${API_BASE_URL}/test-queries`, {
        ...
        body: JSON.stringify({ ...formData, testType: 'PTE' })
      });
    } catch (error) {
      ...
      <div className="page-transition">
        <section className="gradient-primary py-20 md:py-32">
          <div className="container mx-auto px-4 text-center text-white">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Apply for PTE Training</h1>
            <p className="text-lg text-white/80 max-w-2xl mx-auto">Join the biggest PTE campus and achieve your target score.</p>
          </div>
        </section>
